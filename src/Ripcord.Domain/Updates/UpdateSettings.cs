...
/// Whether this host may ask GitHub whether a newer release exists. Off by default and off in
/// the shipped sample: these two machines are meant to have no outbound access at all, so the
/// feature has to be genuinely optional rather than merely skippable.
public sealed record UpdateSettings(bool Check)
{
